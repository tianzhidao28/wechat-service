...
import com.rocyuan.wechat.utils.WeChatHttpResultUtils;
...
public class Login {
	...
	public boolean getQR(String qrPath) {
		...
		WeChatHttpResultUtils.saveWxHttpApi("qrcode",qrUrl,null,null);
		return true;
	}
	...
	public String checkLogin() {
		...
		WeChatHttpResultUtils.saveWxHttpApi("checkLogin",checkUrl,params.stream().map(new Function<BasicNameValuePair, Map<String,Object>>() {
			@Override
			public Map<String, Object> apply(BasicNameValuePair basicNameValuePair) {
				Map<String,Object> t = new HashMap<>();
				t.put(basicNameValuePair.getName(),basicNameValuePair.getValue());
				return t;
			}
	...
	private JSONObject webInit() {
		...
		try {
			...
			WeChatHttpResultUtils.saveWxHttpApi("webwxinit",url,paramMap,obj);
	...
	private void showMobileLogin() {
		...
		try {
			...
			WeChatHttpResultUtils.saveWxHttpApi("webwxstatusnotify",mobileUrl,paramMap,result);
		} catch (Exception e) {
	...
	String syncCheck() {
		...
		WeChatHttpResultUtils.saveWxHttpApi("synccheck",url,params,result);
	...
	JSONObject getMsg() {
		...
		WeChatHttpResultUtils.saveWxHttpApi("webwxsync",url,paramMap,result);
		return result;
	...
	boolean webWxGetContact() {
		...
		WeChatHttpResultUtils.saveWxHttpApi("webwxgetcontact",url,params,fullFriendsJsonList);
